-- Omarchy uses this catalogue to support its theme switcher. Keep it out of
-- ordinary Neovim installs so macOS and other Linux distributions only load
-- the selected theme from plugins/theme.lua.
