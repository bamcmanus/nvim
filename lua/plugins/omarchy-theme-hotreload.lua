if not require("platform.omarchy").is_active() then
  return {}
end
...
return {
	{
		...
		priority = 1000,
		config = function()
			-- Apply Omarchy's transparent UI only on Omarchy. Other platforms keep
			-- their normal theme backgrounds.
			require("platform.omarchy.transparency")
						...
						for _, spec in ipairs(theme_spec) do
							if spec[1] == "LazyVim/LazyVim" and spec.opts and spec.opts.colorscheme then
								...
								vim.defer_fn(function()
									...
									vim.defer_fn(function()
										package.loaded["platform.omarchy.transparency"] = nil
										pcall(require, "platform.omarchy.transparency")
